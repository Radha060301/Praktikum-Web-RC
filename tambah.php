...
}elseif (isset($_POST['valid']) === 0)  {
  echo" <script type= text/javascript> alert('Data Tidak Masuk !'); </script>";
}
...
<label>Nama</label>
<input class="form-control form-control-lg" type="text" aria-label=".form-control-lg example" name="name">
<label>Prodi</label>
